...
export default function OrphanageDetails() {
    ...
    useEffect(() => {
        // Variáveis usadas aqui dentro, é bom colocar no array do 2º parâmetro para o useEfect ficar monitorando
        // Se essa variável for alterada, o useEffect executa novamente
